...
// Set overwrites an account's cached totals outright. It is meant for
// seeding the cache from durable storage at startup, not for the hot
// ingestion path, which should use Record.
